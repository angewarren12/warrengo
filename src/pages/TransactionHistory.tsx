    ...
    <Layout>
      <div className="container mx-auto px-4 pt-4 pb-24">
        ...
        <div className="mb-5 space-y-3">
          ...
          {showFilters && (
            <div className="rounded-lg border bg-card shadow-sm p-3 animate-in fade-in duration-200">
                  ...
                  {trxs.map((trx) => (
                    ...
                    >
                      <CardContent className="p-0">
                        ...
                        {expandedTrx === trx.id && (
                          <div className="border-t p-4 bg-muted/10 space-y-3 animate-in fade-in duration-200">
